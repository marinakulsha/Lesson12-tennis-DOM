(function() {
    ...
    court.id = 'courtId';
    court.style.cssText = 'width: 600px;height:400px; margin:0; position:relative; border: solid rgb(95, 92, 92) 1px;  background-color: #fffb02;';
    section.appendChild(court);

    //создаем мяч
    var ballElem = document.createElement('div');
    ballElem.id = 'ball';
    ballElem.style.cssText = 'width:30px; height:30px; border-radius:50%; top:195px; left:295px; position:absolute; background-color:red;';
    court.appendChild(ballElem);

    //создаем рокетку1
    var paddle1 = document.createElement('div');
    paddle1.id = 'paddle1';
    paddle1.style.cssText = 'width:15px; height:150px; top:129.5px; left:0px; position:absolute; background-color:green;';
    court.appendChild(paddle1);

    //создаем рокетку2
    var paddle2 = document.createElement('div');
    paddle2.id = 'paddle2';
    paddle2.style.cssText = 'width:15px; height:150px; top:129.5px; right:0px; position:absolute; background-color:blue;';
